			...
			<HeaderWithContent.Content>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 items-stretch gap-8">
					<Reveal className="h-full">
						<div className="flex flex-col items-center text-center space-y-4 p-8 rounded-2xl border-2 border-emerald-200 dark:border-emerald-900/50 bg-gradient-to-br from-emerald-50/50 to-transparent dark:from-emerald-950/20 hover:scale-105 transition-transform h-full">
					...
					<Reveal className="h-full">
						<div className="flex flex-col items-center text-center space-y-4 p-8 rounded-2xl border-2 border-violet-200 dark:border-violet-900/50 bg-gradient-to-br from-violet-50/50 to-transparent dark:from-violet-950/20 hover:scale-105 transition-transform h-full">
					...
					<Reveal className="h-full">
						<div className="flex flex-col items-center text-center space-y-4 p-8 rounded-2xl border-2 border-cyan-200 dark:border-cyan-900/50 bg-gradient-to-br from-cyan-50/50 to-transparent dark:from-cyan-950/20 hover:scale-105 transition-transform h-full">
					...
					<Reveal className="h-full">
						<div className="flex flex-col items-center text-center space-y-4 p-8 rounded-2xl border-2 border-amber-200 dark:border-amber-900/50 bg-gradient-to-br from-amber-50/50 to-transparent dark:from-amber-950/20 hover:scale-105 transition-transform h-full">
